...
import ActionRepository from "./views/actionrepository/ActionRepository";
...
import NewDynamic from "./views/dynamic/NewDynamic1";
import DynamicDetail from "./views/dynamic/DynamicDetail";
import DynamicPicture from "./views/dynamic/DynamicPicture";
import CameraVideo from "./views/dynamic/CameraVideo";
import RecVideo from "./views/dynamic/RecVideo";
import VideoDetail from "./views/dynamic/VideoDetail";
...
import ThemeActivity from "./views/themeactivity/ThemeActivity";
import OfTheHill from "./views/of-the-hill/OfTheHill";
import Consult from "./views/consult/Consult";
import Feedback from "./views/feedback/Feedback";
import PrivateOrder from "./views/privateorder/PrivateOrder";
import PartActionRepositorydetails from "./views/actionrepository/components/PartActionRepositorydetails";
import GroupActionRepositorydetails from "./views/actionrepository/components/GroupActionRepositorydetails";
        ...
        return (
            <Router hideNavBar={true} createReducer={this.reducerCreate.bind(this)}>
                <Scene key="root" hideNavBar>
                    ...
                    <Scene key="cameraVideo" component={CameraVideo} title="视频录制" hideNavBar/>
                    <Scene key="recVideo" component={RecVideo} title="录制完成" hideNavBar/>
                    <Scene key="videoDetail" component={VideoDetail} title="视频" hideNavBar/>

                    <Scene key="consult" component={Consult} title="今日运动"/>
                    <Scene key="activity" component={Activity} title="活动"/>
                    <Scene key="themeActivity" component={ThemeActivity} title="活动"/>
                    ...
                    <Scene key="actionRepository" component={ActionRepository} title="动作库" hideNavBar/>
                    <Scene key="privateOrder" component={PrivateOrder} title="私人订制" hideNavBar/>
                    <Scene key="partActionRepositorydetails" component={PartActionRepositorydetails} title="动作库详情" hideNavBar/>
                    <Scene key="groupActionRepositorydetails" component={GroupActionRepositorydetails} title="动作库详情" hideNavBar/>
